"use strict";
(self["webpackChunkstorybookhtml"] = self["webpackChunkstorybookhtml"] || []).push([["vendors-node_modules_storybook_components_dist_formatter-S4K5WUZV_mjs"],{
...
`)),string+=indentedValue+strings[i+1]}),string}var formatter=memoizerific__WEBPACK_IMPORTED_MODULE_1___default()(2)((type,source)=>type===!1?source:type==="dedent"||type===!0?dedent(source):import_standalone.default.format(source,{parser:type,plugins:[import_parser_html.default],htmlWhitespaceSensitivity:"ignore"}).trim());


/***/ })

}]);
//# sourceMappingURL=vendors-node_modules_storybook_components_dist_formatter-S4K5WUZV_mjs.iframe.bundle.js.map